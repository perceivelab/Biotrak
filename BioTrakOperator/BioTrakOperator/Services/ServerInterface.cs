...
{/*
    internal class ServerInterface
    {
        ...
        private class RequestClient
        {
            ...
            internal void AddHeader(string header, string val)
            {
                Request.AddHeader(header, val);
            }

            internal void AddBody(object obj)
            {
                Request.AddJsonBody(obj);
            }
        }

        internal static async Task AcceptProduct(User user, string id)
        {
            RequestClient _client = new RequestClient(new Uri(SERVER_ADDRESS), String.Format("tracks/{0}/{1}", id, user.IsTransport? TRACKSTATE.TRANSPORT_START:TRACKSTATE.ACCEPTED), Method.PUT);
        ...
        internal static async Task TerminateTrack(User user, string id)
        {
        ...
        public static async Task<Track> AddOrUpdateTrack(User user, String name, String internalId,  List<object> items, bool update)
        {
            ...
            parameters.Add("batchCode",internalId);
        ...
        internal static async Task<bool> GetTreeForItemID(string itemID)
        {
            return false;
        }
    }*/
